  ...
  <div id="login">
    ...
    <div id="login-module-div">
      ...
      <div class="el-input-div" style="margin-top: 40px;">
        <el-input v-model="loginInput.nameValue"  placeholder="请输入账号" :prefix-icon="Avatar"   @input="changeHandle($event)"></el-input>
      </div>

      <!-- 密码 -->
      <div class="el-input-div" style="margin-top: 20px;">
        <el-input v-model="loginInput.pwdValue" placeholder="请输入密码" :prefix-icon="Lock" @input="pwdChangeHandle($event)"  show-password></el-input>
      </div>
      ...
      <div class="el-input-div" style="margin-top: 20px;">
        ...
        <div class="imgCode-input">
          <el-input  v-model="loginInput.codeInputValue" placeholder="请输入验证码" :prefix-icon="Check" @input="codeChangeHandle($event)"></el-input>
        </div>

        <!-- 图形 -->
        <div class="imgCode-imageValidate-div" @click="refreshCode">
          <imageValidate :contentWidth=100 :contentHeight=40 :identifyCode="identifyCode"></imageValidate>
        </div>
      </div>

      <!--登录按钮-->
      <div class="login-button-div">
      <el-button class="login-button" type="primary" @click="loginActionFunc">登 录</el-button>
      </div>

      <!-- 注册按钮-->
      <div>
        <button class="lmd-register-button" @click="registerActionFunc">注 册</button>
      </div>
